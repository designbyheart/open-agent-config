...
trigger: Deciding what belongs in actions vs a shared service layer, or extracting operational mechanics repeated across 2+ callers. Related skills — code-structure-cleanup, agentic-engineering-workflow. Don't extract logic used by only one caller.
---
