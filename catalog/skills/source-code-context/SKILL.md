...
trigger: An agent is guessing API names or framework behavior — give it local source-code references so it searches the real implementation before coding.
---
