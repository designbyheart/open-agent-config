...
trigger: Building an MVP, feature, or internal tool with an AI coding agent and wanting a repeatable workflow rather than ad-hoc prompting. Related skills — code-structure-cleanup, code-structure. Skip for one-off tiny edits.
---
